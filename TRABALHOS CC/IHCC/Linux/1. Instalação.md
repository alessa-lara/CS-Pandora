...
Por fim, é relevante destacar alguns comandos que possam ser úteis para a administração de usuários e grupos, como o comando *id* [nomeUsuario], que pode listar o usuário, sua identificação e os grupos nos quais este está inserido.